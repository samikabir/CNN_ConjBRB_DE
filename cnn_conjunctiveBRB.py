...
def ruleBase():             
    ...
    consequentBeliefDegree = [cbd_0, cbd_1, cbd_2, cbd_3, cbd_4, cbd_5, cbd_6, cbd_7, cbd_8, cbd_9, cbd_10, cbd_11, cbd_12, cbd_13, cbd_14, cbd_15, cbd_16, cbd_17, cbd_18, cbd_19, cbd_20, cbd_21, cbd_22, cbd_23, cbd_24, cbd_25, cbd_26]   
...
def calculateMatchingDegreeBrbCnn():
    ...
    matchingDegree = [1.51, 1.51, 1.51, 1.51, 1.51, 1.51, 1.51, 1.51, 1.51]
    ...
    for c in range(3):
        for d in range(3):
            #print(ti1[c])
            matchingDegree[increment] = (ti1[c] ** relativeWeight) * (ti2[d] ** relativeWeight) 
...
def showActivationWeight():  
    ...
    activationWeight = [1.51, 1.41, 1.45, 1.45, 1.45, 1.45, 1.45, 1.45, 1.45]       
...
def aggregateER_BrbCnn():  
    ...
    ruleWiseBeliefDegreeSum = [1.51, 1.51, 1.51, 1.51, 1.51, 1.51, 1.51, 1.51, 1.51]
